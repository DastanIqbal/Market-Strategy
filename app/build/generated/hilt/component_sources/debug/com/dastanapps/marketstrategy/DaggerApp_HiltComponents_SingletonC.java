...
import com.dastanapps.marketstrategy.data.NSEDataSource;
import com.dastanapps.marketstrategy.data.NSERepo;
import com.dastanapps.marketstrategy.di.AppModule_DispatcherFactory;
...
import com.dastanapps.marketstrategy.viewmodels.MainViewModel_HiltModules_KeyModule_ProvideFactory;
...
public final class DaggerApp_HiltComponents_SingletonC {
  ...
  private static final class ViewModelCImpl extends App_HiltComponents.ViewModelC {
    ...
    private NSEDataSource nSEDataSource() {
      return new NSEDataSource(new NetworkExecutor(), AppModule_DispatcherFactory.dispatcher());
    }

    private NSERepo nSERepo() {
      return new NSERepo(nSEDataSource(), AppModule_DispatcherFactory.dispatcher());
    }

    private GetDaysAverageUseCase getDaysAverageUseCase() {
      return new GetDaysAverageUseCase(nSERepo());
    }
    ...
    public Map<String, javax.inject.Provider<ViewModel>> getHiltViewModelMap() {
      return Collections.<String, javax.inject.Provider<ViewModel>>singletonMap("com.dastanapps.marketstrategy.viewmodels.MainViewModel", ((Provider) mainViewModelProvider));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.dastanapps.marketstrategy.viewmodels.MainViewModel 
          return (T) new MainViewModel(viewModelCImpl.getDaysAverageUseCase());
